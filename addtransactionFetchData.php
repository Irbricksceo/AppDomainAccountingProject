...
$sql = "SELECT t.transactionID, t.accountID, fa.faccount, t.debit, t.credit FROM transactions t JOIN faccount fa ON fa.faccountID = t.accountID WHERE t.status = 3";
